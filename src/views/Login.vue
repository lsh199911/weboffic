<template>
  <div>
    <el-form :rules="rules" element-loading-text="正在登陆。。" element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.8)" ref="loginForm" :model="loginForm" class="loginContainer">
...
export default {
  ...
  data () {
    return {
      // captchaUrl: '/captcha?tiome=' + new Data(),
